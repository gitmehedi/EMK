function openerp_pos_ticket(instance, module) { // module is
    ...
    module.Order = module.OrderLoyal.extend({
        getPoint: function () {
            return 500;
        }
    });
...
openerp.point_of_sale = function (instance) {
    ...
    openerp_pos_ticket(instance, module); // import openerp_pos_loyalty.js
