...
class ProductGateIn(models.Model):
    ...
    shipping_line_ids = fields.One2many('stock.gate.line','parent_id',required=True,readonly=True,states={'draft': [('readonly', False)]})
    ...
    def _search_shipment_lc_id(self, operator, value):
        ...
        gate_in_ids = self.env['stock.gate.in'].search([('ship_id', 'in', ship_ids.ids)])
