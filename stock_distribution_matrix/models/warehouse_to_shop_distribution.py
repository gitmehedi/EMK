...
class WarehouseToShopDistribution(models.Model):
    ...
    def action_transfer(self):
        ...
        picking = self.get_picking(src_loc=warehouse.stock_location_id, dest_loc=transit_location)
    ...
    def action_receive(self):
        ...
        picking = self.get_picking(src_loc=transit_location, dest_loc=shop.stock_location_id)
