...
class PurchaseAdvancePaymentInv(osv.osv_memory):
    ...
    def onchange_method(self, cr, uid, ids, advance_payment_method, context=None):
    ...
    def _prepare_advance_invoice_vals(self, cr, uid, ids, context=None):
        ...
        result = []
        for purchase in purchse_obj.browse(cr, uid, purchase_ids, context=context):
            ...
            if wizard.advance_payment_method == 'percentage':
                ...
                if not res.get('name'):
                    res['name'] = self._translate_advance(cr, uid, percentage=True,
                                                          context=dict(context, lang=purchase.partner_id.lang)) % (
                                      wizard.amount)
            else:
                ...
                if not res.get('name'):
                    ...
                    res['name'] = self._translate_advance(cr, uid, context=dict(context,
                                                                                lang=purchase.partner_id.lang)) % symbol_order
    ...
    def create_invoices(self, cr, uid, ids, context=None):
        ...
        if wizard.advance_payment_method == 'lines':
            ...
            res['context'] = {
                ...
                'search_default_order_id': purchase_ids and purchase_ids[0] or False,
            }
            return res
