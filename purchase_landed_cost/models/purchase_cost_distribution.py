...
class PurchaseCostDistribution(models.Model):
    ...
    def _product_price_update(self, move, new_price, old_price):
        ...
        if (move.location_id.usage == 'supplier' and
            ...
            old_std_price = product.standard_price
            ...
            if product_avail <= 0:
                ...
                #                  qty_available)
                new_std_price = ((old_std_price * qty_available -
                                  old_price * move.product_qty +
                                  new_price * move.product_qty) /
                                 qty_available)
    ...
    def action_cancel(self):
        ...
        for line in self.cost_lines:
            if self.cost_update_type == 'direct':
                ...
                self._product_price_update(
                    line.move_id, line.standard_price_old, line.standard_price_old)
                line.move_id.product_price_update_after_done()
        self.state = 'draft'
