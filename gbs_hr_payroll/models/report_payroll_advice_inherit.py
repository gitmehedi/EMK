...
class payroll_advice_report(models.AbstractModel):
    ...
    def get_bysal_total(self):
        return math.ceil(self.total_bysal)

    def amt_to_word(self):
        return self.env['res.currency'].amount_to_word(float(math.ceil(self.total_bysal)))
    ...
    def render_html(self, docids, data=None):
        ...
        docargs = {
            ...
            'amount_to_text_bdt': self.amt_to_word
        }
