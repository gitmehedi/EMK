...
class AccountMoveLine(models.Model):
    ...
    partner_type = fields.Selection([('person', 'Individual'), ('company', 'Company')], string='Partner Type',
    ...
    def action_challan_generate_open(self, records):
        ...
        res_view = self.env.ref('account_tax_challan.tds_vat_challan_form_view')
