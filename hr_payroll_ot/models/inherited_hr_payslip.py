...
class InheritHRPayslip(models.Model):
    ...
    #         raise ValidationError(_("Arrear Data Error For: " + self.name + " hr_payslip_id :" + str(
    #             self.id) + ". Need to Update 'ref' from hr_pay_slip_input where id is :" + str(
    #             pay_slip_input) + ", existing ref : " + str(arrear_ids)))
    #
    #     return res
    #
    # @api.onchange('employee_id', 'date_from', 'date_to')
    # def onchange_employee(self):
    #     print("############# onchange_employee:", self.employee_id)
    #     if self.employee_id:
