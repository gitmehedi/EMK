...
class AccessCodeModel(models.AbstractModel):
    _name = 'report.event_registration.temporary_pass_tmpl'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('event_registration.temporary_pass_tmpl', docargs)
