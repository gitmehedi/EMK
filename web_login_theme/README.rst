...
Usage
=====
Maybe images in github do not fit with the Odoo apps, so you can check: https://apps.odoo.com/apps/modules/10.0/web_login_theme/ for more details.
Thank you.
...
.. note::  Remmember that, install *web_login_theme* **after** install module *website*. Or please **upgrade** *web_login_theme* after install module *website*
