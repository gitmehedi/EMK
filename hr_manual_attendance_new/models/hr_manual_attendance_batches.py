...
class HrManualAttendance(models.Model):
    ...
    approbations_ids = fields.One2many('hr.employee.manual.attendance.approbation', 'manual_attendance_id', string='Approvals',
                                   readonly=True)
    ...
    def action_approve(self):
        for manual_attendance in self:
            ...
            if is_last_approbation:
                ...
                self.env['hr.employee.manual.attendance.approbation'].create(
