...
class DocReceiveWizard(models.TransientModel):
    _name = 'doc.receive.wizard.export.foreign'

    product_lines = fields.One2many('shipment.product.line.export.foreign.wizard', 'doc_shipment_id', string='Product(s)')
...
class ShipmentProductLineWizard(models.TransientModel):
    _name = 'shipment.product.line.export.foreign.wizard'
    ...
    doc_shipment_id = fields.Many2one('doc.receive.wizard.export.foreign', string='Purchase Shipment', ondelete='cascade')
