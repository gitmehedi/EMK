	...
	instance.web.search.ExtendedSearchProposition.include({
	    ...
	    get_proposition: function() {
	        ...
	        if (operator.value == '><') {
		        ...
		        if (value1 && value2) {
                               dateParse = Date.parse(value2);
                               formatValue = new Date(dateParse.valueOf() - dateParse.getTimezoneOffset() * 60000).toString('MM/dd/yyyy HH:mm:ss')
                               proposition['label'] += _.str.sprintf(' and "%(value)s"', {value: formatValue});
