...
from odoo.addons.member_signup.models.res_partner import SignupError, now
...
class ResUsers(models.Model):
    ...
    def _signup_create_user(self, values):
        ...
        template_user_id = literal_eval(IrConfigParam.get_param('member_signup.template_user_id', 'False'))
        template_user = self.browse(template_user_id)
        assert template_user.exists(), 'Signup: invalid template user'

        # check that uninvited users may sign up
        if 'partner_id' not in values:
            if not literal_eval(IrConfigParam.get_param('member_signup.allow_uninvited', 'False')):
