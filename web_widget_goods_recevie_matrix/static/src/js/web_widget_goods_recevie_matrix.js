...
openerp.web_widget_goods_recevie_matrix = function(instance)
{
    instance.web.form.widgets.add(
        'goods_receive_matrix',
        'instance.web_widget_goods_recevie_matrix.FieldGoodsReceiveMatrix');
    instance.web_widget_goods_recevie_matrix.FieldGoodsReceiveMatrix = instance.web.form.FieldOne2Many.extend({
        template: 'FieldGoodsReceiveMatrix',
