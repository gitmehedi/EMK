...
class LCAmendment (models.TransientModel):
    _name = "lc.amendment"
    ...
    margin_builts = fields.One2many('margin.built','name')
    ...
    def create(self, vals):
        ...
        return super(LCAmendment, self).create(vals)
    ...
    def write(self, vals):
        ...
        return super(LCAmendment, self).write(vals)
