...
class TTPaymentHeadDetails(models.Model):
    _name = 'tt.payment.head.details'
    ...
    # Relationship fields
    tt_payment_head_id = fields.Many2one('tt.payment', ondelete="CASCADE")
    tt_charge_head_id = fields.Many2one('tt.payment', ondelete="CASCADE")
