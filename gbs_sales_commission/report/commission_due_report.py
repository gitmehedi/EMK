...
class SaleCommissionDueReport(models.Model):
    _name = "commission.due.report"
    _description = "Sale Commission Due Report"
    _auto = False
    _rec_name = 'date'
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.product_id, sub.partner_id, sub.country_id, sub.account_analytic_id,
                ...
                sub.weight, sub.volume, sub.generated_commission_amount AS commission,
