...
class hr_employee(orm.Model):
    ...
    @api.multi
    def get_months_service_to_date(self, dToday=None, context=None):
        ...
        for ee in self:
            ...
            result = (float((delta.years * 12) + delta.months) + date_part, dInitial)
            ee.length_of_service = result[0] if result else 0.0

    
#     @api.model
#     def _get_employed_months(self, context=None):
#         
...
#         return res
    ...
    length_of_service = fields.Float(string='Length of Service', compute='get_months_service_to_date')
