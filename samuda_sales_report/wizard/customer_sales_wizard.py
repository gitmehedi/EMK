...
class CustomerSalesWizard(models.TransientModel):
    _name = "customer.sales.wizard"
    ...
    def process_print(self):
        ...
        return self.env['report'].get_action(self, 'samuda_sales_report.report_customer_sales', data=data)
