...
class DailyUndeliveredStatementWizard(models.TransientModel):
    _name = "daily.undelivered.statement.wizard"
    ...
    def process_print(self):
        ...
        return self.env['report'].get_action(self, 'samuda_sales_report.report_daily_undelivered_statement', data=data)
