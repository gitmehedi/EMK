...
class MonthlyDeliveryExecutiveReport(models.AbstractModel):
    _name = "report.samuda_sales_report.report_monthly_delivery_executive"
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('samuda_sales_report.report_monthly_delivery_executive', docargs)
