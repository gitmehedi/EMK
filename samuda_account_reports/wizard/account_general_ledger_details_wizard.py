...
class AccountGeneralLedgerDetailsWizard(models.TransientModel):
    _name = "account.general.ledger.details.wizard"
    ...
    @api.multi
    def button_export_details_xlsx(self):
        self.ensure_one()
        return self.env['report'].get_action(self, report_name='samuda_account_reports.account_general_ledger_details_xlsx')
