...
class HrHolidays(models.Model):
    ...
    def onchange_date_from(self):
        ...
        if (self.date_to and self.date_from) and (self.date_from <= self.date_to) and days_check:
            diff_day = self._compute_number_of_days(employee_id,self.date_to,self.date_from)
            self.number_of_days_temp = diff_day
