...
class HrEmployeeArrear(models.Model):
    _name = 'hr.payroll.arrear'
    _order = 'name desc'
    ...
    line_ids = fields.One2many('hr.payroll.arrear.line', 'parent_id', string="Arrear Details", readonly=True,
                               states={'draft': [('readonly', False)]})
    ...
    def unlink(self):
        ...
        return super(HrEmployeeArrear, self).unlink()
