...
class sale_report_target_achievement_wise(osv.osv):
    _name = "sale.report.target.achievement.wise"
    _description = "Sales Orders Statistics commitment delay Wise"
    _auto = False
    _rec_name = 'date'
    ...
    _columns = {
        ...
        'target_amount': fields.float('Target Amount', digits=(16,2), readonly=True),
        ...
        select_str = """
            WITH currency_rate (currency_id, rate, date_start, date_end) AS (
             ...
             SELECT min(l.id) as id,
                    ...
                    ru.id as user_id,
                    ru.target_amount as target_amount,
