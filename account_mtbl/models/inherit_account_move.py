...
class AccountMove(models.Model):
    ...
    operating_unit_id = fields.Many2one(string='Branch', required=True, states={'posted': [('readonly', True)]},
...
class AccountMoveLine(models.Model):
    ...
    operating_unit_id = fields.Many2one(string='Branch', required=True)
