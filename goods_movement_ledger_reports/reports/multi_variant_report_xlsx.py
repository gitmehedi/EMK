...
class MultiVariantReportXLSX(ReportXlsx):
...
MultiVariantReportXLSX('report.goods_movement_ledger_reports.multi_variant_report_xlsx',
                       'multi.variant.report.wizard', parser=report_sxw.rml_parse)
