...
class VariantWiseReportXLSX(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, obj):
        ...
        while date_start_obj <= date_end_obj:
            ...
            sales_total = sales_total + delivery_quantity
...
VariantWiseReportXLSX('report.goods_movement_ledger_reports.variant_wise_report_xlsx',
                      'variant.wise.report.wizard', parser=report_sxw.rml_parse)
