...
class PackingList(models.AbstractModel):
    _name = 'report.lc_sales_product_local.report_measurement_list'
    ...
    def render_html(self, docids, data=None):
        ...
        data['invoice_date'] = "" if shipment_obj.invoice_id.id == False else report_utility_pool.getERPDateFormat(
            report_utility_pool.getDateFromStr(shipment_obj.invoice_id.date_invoice))
        if data['invoice_id'] == "":
            ...
            data['invoice_date'] = report_utility_pool.getERPDateFormat(report_utility_pool.getDateFromStr(account_invoice.date_invoice))
        ...
        return self.env['report'].render('lc_sales_product_local.report_measurement_list', docargs)
