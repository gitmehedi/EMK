...
class BeneficiaryCertificate(models.AbstractModel):
    _name = 'report.lc_sales_product_local.report_beneficiary_certificate'
    ...
    def render_html(self, docids, data=None):
        ...
        data['invoice_id'] =  "" if shipment_obj.invoice_id.display_name == False else shipment_obj.invoice_id.display_name
        ...
        return self.env['report'].render('lc_sales_product_local.report_beneficiary_certificate', docargs)
