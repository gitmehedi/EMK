...
class StockTransferSummaryReport(models.AbstractModel):
    _inherit = 'report.stock_transfer_report.sts_report_temp'
    ...
    def get_report_data(self, data):
        ...
        sql_out_tk = '''SELECT category,cetegory_id,
                        ...
                        FROM   (SELECT pp.id AS product_id,                               
                                ...
                                ''' % (operating_unit_id, operating_unit_id, date_start, date_end, location_outsource,
                                       location_outsource, category_param)
