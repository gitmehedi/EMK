...
class StockInventoryReport(models.AbstractModel):
    _inherit = 'report.stock_custom_summary_report.stock_report_template'
    ...
    def get_report_data(self, data):
        ...
        sql_dk = '''
                        ...
                        FROM   (
                                SELECT sm.product_id,
                                        ...
                                        Coalesce((SELECT ph.cost FROM product_price_history ph
                                                  WHERE  Date_trunc('day', ph.datetime+ interval'6h') < '%s'
                     ...
                     ''' % (
        date_start, operating_unit_id, date_start, location_outsource, location_outsource, category_param, product_param,
        date_start, operating_unit_id, date_start, location_outsource, location_outsource, category_param, product_param)
        ...
        sql_in_tk = '''
                                ...
                                GROUP  BY product_id, 
                                          ...
                                          cost_val 
                            ''' % (
        date_end, operating_unit_id, date_end, operating_unit_id, date_start, date_end, location_outsource, location_outsource, category_param, product_param)
        ...
        sql_ck = '''
                ...
                GROUP  BY product_id,
                          ...
                          cost_val 
                            ''' % (
        date_end, operating_unit_id, date_end, location_outsource, location_outsource, category_param, product_param,
        date_end, operating_unit_id, date_end, location_outsource, location_outsource, category_param, product_param)
