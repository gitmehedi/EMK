...
openerp.web_widget_x2many_2d_opening_matrix = function(instance)
{
    instance.web.form.widgets.add(
        'x2many_2d_opening_matrix',
        'instance.web_widget_x2many_2d_opening_matrix.FieldX2Many2dOpneingMatrix');
    instance.web_widget_x2many_2d_opening_matrix.FieldX2Many2dOpneingMatrix = instance.web.form.FieldOne2Many.extend({
        template: 'FieldX2Many2dOpneingMatrix',
        ...
        init: function(field_manager, node)
        {
            ...
            this.field_theoretical_value = node.attrs.field_theoretical_value || this.field_theoretical_value;
        ...
        get_xy_theoretical_value: function(x, y)
        {
            return this.get_field_value(
                this.by_x_axis[x][y], this.field_theoretical_value);
        },
        ...
        // format a value from the database for display
        format_xy_theoretical_value: function(val)
        {
            return instance.web.format_value(
                val, {'type': this.fields[this.field_theoretical_value].type});
        },
