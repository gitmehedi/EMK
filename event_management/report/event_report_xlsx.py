...
class EventReportXLSX(ReportXlsx):
    def generate_event_xlsx_report(self, workbook, data, obj):
...
EventReportXLSX('report.event_management.events_xls', 'event.report.wizard', parser=report_sxw.rml_parse)
