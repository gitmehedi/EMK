...
class EventSocialMediaContent(models.Model):
    _name = 'event.social.media.content'
    _inherit = ['mail.thread', 'ir.needaction_mixin']
    _description = 'Event Social Media Content'
    ...
    def unlink(self):
        for rec in self:
            ...
            try:
                return super(EventSocialMediaContent, rec).unlink()
