...
#         location_outsource = 12
        ...
        sql_dk = '''SELECT product_id,name, code, sum(product_qty_in - product_qty_out) as qty_dk
            ...
            SELECT sm.product_id,pt.name , pp.default_code as code,
                ...
                ) table_dk GROUP BY product_id,name ,code
                    ''' % (date_start, location_outsource,location_outsource, date_start, location_outsource,location_outsource,date_start, location_outsource,location_outsource)
        ...
        sql_ck = '''SELECT product_id,name, code, sum(product_qty_in - product_qty_out) as qty_ck
            ...
            SELECT sm.product_id,pt.name , pp.default_code as code,
                ...
                ) table_ck GROUP BY product_id,name ,code
                    ''' % (date_end, location_outsource,location_outsource, date_end, location_outsource,location_outsource,date_end, location_outsource,location_outsource)
