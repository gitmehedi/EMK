...
class HRJobConfirmation(models.Model):
    _name='hr.job.confirmation'
    _inherit = ['mail.thread']
    _description = 'Employee Job Confirmation'
    ...
    def action_hr_manager_comment(self):
        ...
        result = {
            ...
            'res_model': 'job.confirmation.persons.comment.wizard',
    ...
    def action_cxo_comment(self):
        res = self.env.ref('gbs_hr_job_confirmation.job_confirmation_cxo_comment_wizard')
        result = {
    ...
    def action_supervisor_comment(self):
        res = self.env.ref('gbs_hr_job_confirmation.job_confirmation_supervisor_comment_wizard')
        result = {
    ...
    def action_hod_comment(self):
        res = self.env.ref('gbs_hr_job_confirmation.job_confirmation_hod_comment_wizard')
        result = {
    ...
    def action_plant_incharge_comment(self):
        res = self.env.ref('gbs_hr_job_confirmation.job_confirmation_plant_incharge_comment_wizard')
        result = {
    ...
    def action_judge_incharge(self):
        res = self.env.ref('gbs_hr_job_confirmation.job_confirmation_judgement_wizard')
        result = {
            'name': _('Job Confirmation'),
            'view_type': 'form',
            'view_mode': 'form',
            'view_id': res and res.id or False,
            'res_model': 'job.confirmation.judgement.wizard',
            'type': 'ir.actions.act_window',
            'nodestroy': True,
            'target': 'new',
    ...
    def unlink(self):
        ...
        return super(HRJobConfirmation, self).unlink()
