...
class ToBanglaUtility(models.TransientModel):
    ...
    # input_sanitizer
    def input_sanitizer(self, number):
    ...
    def float_int_extraction(self, number):
        """
    ...
    def generate_segments(self, number):
        """
    ...
    def whole_part_word_gen(self, segments):
        """
        ...
        for segment in segments:
            if segments[segment]:
                sega = int(segments[segment])
                generated_words += numeric_words[str(sega)] + \
                                   " " + units[segment] + " "

        return generated_words[:-2]

    # fraction_to_words
    def fraction_to_words(self, fraction):
        """
